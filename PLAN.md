...
- [ ] Stale-workspace update fix in SettingsPanel handleUpdate (re-read store after saves) + T154 through the real UI + REQ-UPDATE-030; T142b contract pin; CI installs powernote-mcp deps; v0.52.4 released and the 0.37.5→latest update test green with content preserved
## Future (Backlog)
